  ...
  module ConnectionAdapters  # :nodoc:
    module PostGISAdapter  # :nodoc:
      class SpatialColumn < ConnectionAdapters::PostgreSQLColumn  # :nodoc:
        ...
        def self.convert_to_geometry(input, factory_settings, table_name, column, geographic, srid, geometric_type, has_z, has_m)
          input = input.to_wkt(geometric_type.type_name.underscore.to_sym) if input.is_a?(Array)
