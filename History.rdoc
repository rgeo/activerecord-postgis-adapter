...
Thanks to the many who have submitted pull requests. A bunch of them are in this release. Particular thanks to Nick Muerdter, who succeeded in porting the adapter to work with the JDBC Postgres adapter in JRuby, and also got Travis up and running for the project.
