...
_PostGIS 1.5 only_: If you include a schema called "postgis" in the search path,
the adapter will isolate all the
...
### PostGIS 1.5 only: Schema Dump and Reload

_This is not an issue with PostGIS 2.0+_
